export const RESPONSE_EXAMPLES = [
  ...
  export const defaultPromptPrefix = "Let's think step by step. I have a collection of statements, there may be one or many, and I need them transformed to fit better in a market research survey. " +
  ...
  "1. Tone: The revised statements must embody the tones delimited with ```, you should consider which words you can change or add to emobdy that tone and incorporate those words into the transformed statement: Here are the tones: ```{toneValue}```. It's crucial to ensure that these statements are not {negativeTone}.\n\n" +
  ...
  "3. Emojis: Now that the tone and verbosity have been figured out its time to incorporate the emoji quantity delimited with ``` around and throughout the transformed statements.\nThe emoji quantity: ```{emojiQuantity}```.\n\n" +
